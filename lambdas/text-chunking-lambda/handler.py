...
Process:
  ...
  2. Split into 4500-token chunks using tiktoken
  3. Save chunks to TextChunksBucket/{job_id}/chunk_{XXX}.txt
  4. Store metadata: total_chunks, estimated_duration
...
def chunk_text_by_characters(text, max_tokens=4500):
    """
    Fallback: Chunk text by estimated characters
    Rough estimate: 1 token ≈ 4 characters
    """
    chars_per_chunk = max_tokens * 4  # ~18,000 characters
    chunks = []
